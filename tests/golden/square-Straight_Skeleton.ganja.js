Algebra(2,0,1,()=>{
  ...
  var aec = -1.4142135623730951e1+0.0e2+0.0e0;
  var afa = 0.7071067811865475e1-0.7071067811865475e2+0.0e0;
  var afb = 0.7071067811865475e1+0.7071067811865475e2+0.0e0;
  var afc = 1.4142135623730951e1+0.0e2+0.0e0;
  var aga = 1.4142135623730951e1+0.0e2+0.0e0;
  var agb = -1.4142135623730951e1+0.0e2+0.0e0;
