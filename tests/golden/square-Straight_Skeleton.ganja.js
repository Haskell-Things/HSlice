Algebra(2,0,1,()=>{
  ...
  var aec = -1.414213562373095e1+0.0e2+0.0e0;
  var afa = 1.0e1-1.0e2+0.0e0;
  var afb = 1.0e1+1.0e2+0.0e0;
  var afc = 1.414213562373095e1+0.0e2+0.0e0;
  var aga = 1.414213562373095e1+0.0e2+0.0e0;
  var agb = -1.414213562373095e1+0.0e2+0.0e0;
