Algebra(2,0,1,()=>{
  ...
  var af = 0.7071067811865476e1-1.7071067811865475e2-1.0e0;
  ...
  var aj = 0.7071067811865476e1-1.7071067811865475e2-1.0e0;
  var ak = -1.0e1+1.0e2+0.0e0;
  var al = -0.41421356237309503e1-0.17157287525381004e2+0.2426406871192852e0;
  var am = 0.41421356237309515e1-0.17157287525380993e2-0.24264068711928524e0;
  var an = 1.0e1+1.0e2+0.0e0;
  var ao = -0.7071067811865476e1-1.7071067811865475e2+1.0e0;
  var ap = -1.0e1+1.0e2+0.0e0;
  var aq = 0.0e1-1.414213562373095e2+0.0e0;
  var ar = -0.41421356237309503e1-0.17157287525381004e2+0.2426406871192852e0;
  var as = -0.7071067811865476e1-1.7071067811865475e2+1.0e0;
