...
onSegment ls i startUlp endUlp =
  ...
  where
    ...
    startFudgeFactor = realToFrac $ ulpVal $ startDistanceErr <> startUlp
    midFudgeFactor = realToFrac $ ulpVal $ midDistanceErr <> UlpSum (realToFrac $ doubleUlp lengthOfSegment)
