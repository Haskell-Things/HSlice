...
onSegment ls i startUlp endUlp =
  ...
  where
    ...
    startFudgeFactor = realToFrac $ ulpVal $ startDistanceErr <> tFuzz <> startUlp
    midFudgeFactor = realToFrac $ ulpVal $ midDistanceErr <> tFuzz <> UlpSum (realToFrac $ doubleUlp lengthOfSegment)
    endFudgeFactor = realToFrac $ ulpVal $ endDistanceErr <> tFuzz <> endUlp
